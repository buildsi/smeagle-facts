...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-haswell/gcc-11.2.0/hdf5-1.10.1-twpl2txfqxh5mhjmpcwq4buir5wz7iip/bin/ph5diff
%----------------------------------------------------------------------------
abi_typelocation("a","MPI_Send","Import","Integer8","(())").
abi_typelocation("a","MPI_Abort","Import","Integer8","(())").
abi_typelocation("a","MPI_Recv","Import","Integer8","(())").
abi_typelocation("a","MPI_Probe","Import","Integer8","(())").
...
abi_typelocation("a","MPI_Comm_set_attr","Import","Integer8","%rdi").
...
abi_typelocation("a","OMPI_C_MPI_NULL_COPY_FN","Import","Integer8","%rdi").
...
abi_typelocation("a","MPI_Bcast","Import","Integer8","%rsi").
abi_typelocation("a","MPI_Bcast","Export","Integer8","%rax").
...
abi_typelocation("a","MPI_File_get_atomicity","Export","Integer8","%rax").
abi_typelocation("a","MPI_File_set_atomicity","Import","Integer8","%rsi").
abi_typelocation("a","MPI_File_set_atomicity","Export","Integer8","%rax").
...
abi_typelocation("a","MPI_Bcast","Export","Integer8","%rax").
abi_typelocation("a","MPI_File_get_size","Export","Integer8","%rax").
abi_typelocation("a","MPI_Comm_size","Export","Integer8","%rax").
abi_typelocation("a","MPI_Comm_rank","Export","Integer8","%rax").
abi_typelocation("a","MPI_File_open","Import","Integer8","%rdi").
abi_typelocation("a","MPI_File_open","Export","Integer8","%rax").
abi_typelocation("a","MPI_File_close","Export","Integer8","%rax").
abi_typelocation("a","MPI_File_read_at","Import","Integer8","%rsi").
abi_typelocation("a","MPI_File_read_at","Import","Integer8","%rdx").
abi_typelocation("a","MPI_File_read_at","Export","Integer8","%rax").
abi_typelocation("a","MPI_File_read_at_all","Import","Integer8","%rsi").
abi_typelocation("a","MPI_File_read_at_all","Import","Integer8","%rdx").
abi_typelocation("a","MPI_File_read_at_all","Export","Integer8","%rax").
abi_typelocation("a","MPI_Type_size_x","Export","Integer8","%rax").
abi_typelocation("a","MPI_Get_elements_x","Export","Integer8","%rax").
abi_typelocation("a","MPI_File_write_at","Import","Integer8","%rsi").
abi_typelocation("a","MPI_File_write_at","Export","Integer8","%rax").
abi_typelocation("a","MPI_File_write_at_all","Import","Integer8","%rsi").
abi_typelocation("a","MPI_File_write_at_all","Export","Integer8","%rax").
abi_typelocation("a","MPI_File_set_view","Export","Integer8","%rax").
abi_typelocation("a","MPI_File_sync","Export","Integer8","%rax").
abi_typelocation("a","MPI_Barrier","Export","Integer8","%rax").
abi_typelocation("a","MPI_Error_string","Import","Integer8","%rdi").
abi_typelocation("a","MPI_Error_string","Import","Integer16","%rsi").
abi_typelocation("a","MPI_Error_string","Export","Integer8","%rax").
abi_typelocation("a","MPI_File_set_size","Export","Integer8","%rax").
abi_typelocation("a","MPI_Barrier","Export","Integer8","()").
abi_typelocation("a","compress2","Import","Integer8","()").
abi_typelocation("a","compress2","Export","Integer8","()").
abi_typelocation("a","inflateEnd","Export","Integer8","()").
abi_typelocation("a","inflate","Import","Integer8","()").
abi_typelocation("a","inflate","Export","Integer8","()").
abi_typelocation("a","inflateInit_","Import","Integer8","()").
abi_typelocation("a","inflateInit_","Export","Integer8","()").
