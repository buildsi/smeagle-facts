...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-haswell/gcc-11.2.0/hdf5-1.12.0-aquuqa7fd4nw3rh2rjj2z3rakghgyl3u/bin/h5copy
%----------------------------------------------------------------------------
abi_typelocation("a","ompi_mpi_byte","Import","Integer8","()").
abi_typelocation("a","ompi_mpi_unsigned","Import","Integer8","()").
...
abi_typelocation("a","MPI_Isend","Both","Integer32","(%rdi)").
abi_typelocation("a","MPI_Scatterv","Both","Integer32","(%rdi)").
abi_typelocation("a","MPI_Allgather","Both","Integer32","(%rdi)").
abi_typelocation("a","MPI_Allreduce","Both","Integer32","(%rdi)").
abi_typelocation("a","MPI_Error_string","Import","Integer64","%rdi").
