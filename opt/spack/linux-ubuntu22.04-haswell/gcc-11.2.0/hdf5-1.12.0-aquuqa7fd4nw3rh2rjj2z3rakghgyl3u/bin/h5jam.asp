...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-haswell/gcc-11.2.0/hdf5-1.12.0-aquuqa7fd4nw3rh2rjj2z3rakghgyl3u/bin/h5jam
%----------------------------------------------------------------------------
...
abi_typelocation("a","MPI_Type_contiguous","Import","Integer32","%rsi").
...
abi_typelocation("a","MPI_Gatherv","Import","Integer32","%rdx").
abi_typelocation("a","MPI_Gatherv","Import","Integer64","%rcx").
...
abi_typelocation("a","MPI_Allgatherv","Import","Integer32","%rdx").
...
abi_typelocation("a","MPI_Gather","Import","Integer64","%r8").
...
abi_typelocation("a","MPI_Isend","Import","Integer64","%rcx").
...
abi_typelocation("a","MPI_Scatterv","Import","Integer64","%rcx").
...
abi_typelocation("a","MPI_Type_create_hindexed","Import","Integer64","%rdi").
abi_typelocation("a","MPI_Type_create_hindexed","Import","Integer64","%rdx").
abi_typelocation("a","MPI_Type_create_hindexed","Export","Integer64","%rax").
...
abi_typelocation("a","MPI_Type_vector","Import","Integer64","%rcx").
...
abi_typelocation("a","MPI_Error_string","Export","Integer64","%rax").
abi_typelocation("a","MPI_Type_contiguous","Import","Integer64","%rdi").
abi_typelocation("a","MPI_Type_contiguous","Import","Integer64","%rsi").
abi_typelocation("a","MPI_Type_contiguous","Export","Integer64","%rax").
abi_typelocation("a","MPI_Barrier","Export","Integer64","%rax").
abi_typelocation("a","MPI_Type_create_struct","Import","Float64","%xmm0").
