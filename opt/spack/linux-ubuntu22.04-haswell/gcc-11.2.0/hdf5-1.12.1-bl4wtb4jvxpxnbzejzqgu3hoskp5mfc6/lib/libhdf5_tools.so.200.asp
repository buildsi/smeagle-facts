...
abi_typelocation("a","H5Lget_info2","Import","Integer8","()").
...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-haswell/gcc-11.2.0/hdf5-1.12.1-btslw3f4tivk2iwyitlzhoa4czapckzf/lib/libhdf5.so.200.1.0
%----------------------------------------------------------------------------
...
abi_typelocation("b","H5VL_native_register","Export","Void","()").
abi_typelocation("b","H5FD_sec2_init","Export","Void","()").
abi_typelocation("b","H5Pget_vol_id","Import","Void","()").
abi_typelocation("b","H5Pset_vol","Import","Void","()").
abi_typelocation("b","H5Pset_vol","Import","Void","()").
abi_typelocation("b","H5Pget_driver","Import","Void","()").
abi_typelocation("b","H5Pget_driver","Export","Void","()").
