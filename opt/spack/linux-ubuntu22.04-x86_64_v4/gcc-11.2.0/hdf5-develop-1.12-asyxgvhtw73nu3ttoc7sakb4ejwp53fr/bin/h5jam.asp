...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-develop-1.12-asyxgvhtw73nu3ttoc7sakb4ejwp53fr/bin/h5jam
%----------------------------------------------------------------------------
abi_typelocation("a","ompi_mpi_comm_world","Import","Integer64","var").
abi_typelocation("a","ompi_mpi_datatype_null","Import","Integer8","()").
abi_typelocation("a","ompi_mpi_int","Import","Integer8","()").
abi_typelocation("a","ompi_mpi_unsigned_long","Import","Integer8","()").
abi_typelocation("a","ompi_mpi_unsigned_long_long","Import","Integer8","()").
abi_typelocation("a","ompi_mpi_uint64_t","Import","Integer8","()").
abi_typelocation("a","ompi_mpi_c_bool","Import","Integer8","()").
...
abi_typelocation("a","MPI_Gather","Import","Integer16","%rsi").
...
abi_typelocation("a","MPI_Irecv","Import","Integer16","%rdi").
abi_typelocation("a","MPI_Get_elements_x","Import","Integer16","%rdi").
abi_typelocation("a","MPI_Issend","Import","Integer16","%rdi").
abi_typelocation("a","MPI_Type_create_resized","Import","Integer16","%rdi").
abi_typelocation("a","MPI_Scatterv","Import","Integer16","%rdi").
abi_typelocation("a","MPI_Scatterv","Import","Integer16","%rsi").
abi_typelocation("a","MPI_Bcast","Import","Integer16","%rdi").
abi_typelocation("a","MPI_Allgather","Import","Integer16","%rdi").
abi_typelocation("a","MPI_Allgather","Import","Integer16","%rsi").
