...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-develop-1.12-asyxgvhtw73nu3ttoc7sakb4ejwp53fr/bin/h5clear
%----------------------------------------------------------------------------
...
abi_typelocation("a","MPI_Testall","Import","Integer8","()").
abi_typelocation("a","MPI_Test","Import","Integer8","()").
abi_typelocation("a","MPI_Irecv","Import","Integer8","%rdi").
abi_typelocation("a","MPI_Get_elements_x","Import","Integer8","%rdi").
abi_typelocation("a","MPI_Iprobe","Import","Integer8","()").
abi_typelocation("a","MPI_Issend","Import","Integer8","%rdi").
abi_typelocation("a","MPI_Type_create_resized","Import","Integer8","%rdi").
abi_typelocation("a","MPI_Scatterv","Import","Integer8","%rdi").
abi_typelocation("a","MPI_Scatterv","Import","Integer8","%rsi").
