...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-1.13.0-vhuqnzz4cxgoh2irs4e6fipp7m6lnxtd/bin/h5ls
%----------------------------------------------------------------------------
...
abi_typelocation("a","MPI_Type_create_struct","Import","Array","framebase+24").
...
abi_typelocation("a","MPI_Type_create_struct","Import","Integer32","framebase+48").
abi_typelocation("a","MPI_Type_create_struct","Import","Integer8","framebase+52").
abi_typelocation("a","MPI_Type_create_struct","Import","Integer64","framebase+56").
abi_typelocation("a","MPI_Type_create_struct","Import","Integer32","framebase+64").
abi_typelocation("a","MPI_Type_create_struct","Import","Union","framebase+72").
abi_typelocation("a","MPI_Type_create_struct","Import","Integer32","framebase+88").
abi_typelocation("a","MPI_Type_create_struct","Import","Integer32","framebase+92").
