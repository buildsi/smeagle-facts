...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-1.13.0-vhuqnzz4cxgoh2irs4e6fipp7m6lnxtd/bin/h5stat
%----------------------------------------------------------------------------
...
abi_typelocation("a","MPI_Gatherv","Both","Void","(%rsi)").
...
abi_typelocation("a","MPI_Scatterv","Both","Void","(%rdi)").
...
abi_typelocation("a","MPI_Allgather","Both","Void","(%rsi)").
abi_typelocation("a","MPI_Allgather","Import","Integer32","%rdx").
