...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-1.10.9-ut43rwaay3t6hmz4fbpy2njm726yhwgl/bin/h5mkgrp
%----------------------------------------------------------------------------
...
abi_typelocation("a","MPI_Testall","Import","Empty","none").
abi_typelocation("a","MPI_Waitall","Import","Empty","none").
abi_typelocation("a","MPI_Test","Import","Empty","none").
abi_typelocation("a","MPI_Iprobe","Import","Empty","none").
...
abi_typelocation("a","MPI_Type_create_struct","Export","Integer8","(%rdi)").
abi_typelocation("a","MPI_Type_create_struct","Export","Integer8","%rsi").
abi_typelocation("a","MPI_Type_create_struct","Export","Integer8","%rsi").
abi_typelocation("a","MPI_Type_create_struct","Export","Integer8","%rsi").
abi_typelocation("a","MPI_Type_create_struct","Export","Integer64","%rdx").
abi_typelocation("a","MPI_Type_create_struct","Export","Integer8","((%rcx+24)+24)").
abi_typelocation("a","MPI_Type_create_struct","Export","Integer64","%r8").
