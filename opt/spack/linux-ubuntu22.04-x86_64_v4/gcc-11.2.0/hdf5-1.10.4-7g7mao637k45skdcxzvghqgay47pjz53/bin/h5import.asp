...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-1.10.4-7g7mao637k45skdcxzvghqgay47pjz53/bin/h5import
%----------------------------------------------------------------------------
...
abi_typelocation("a","inflateEnd","Both","Integer8","((%rdi))").
abi_typelocation("a","inflate","Both","Integer8","((%rdi))").
abi_typelocation("a","inflateInit_","Both","Integer8","((%rdi))").
