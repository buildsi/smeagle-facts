...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/darshan-util-3.1.8-hr7owmgnumne7i3vh3xrsmi6paeibw4q/bin/darshan-parser
%----------------------------------------------------------------------------
abi_typelocation("a","deflateEnd","Import","Integer32","%rdi").
abi_typelocation("a","inflateEnd","Import","Integer32","%rdi").
abi_typelocation("a","deflateReset","Import","Integer32","%rdi").
abi_typelocation("a","deflate","Import","Integer32","%rdi").
abi_typelocation("a","inflateReset","Import","Integer32","%rdi").
