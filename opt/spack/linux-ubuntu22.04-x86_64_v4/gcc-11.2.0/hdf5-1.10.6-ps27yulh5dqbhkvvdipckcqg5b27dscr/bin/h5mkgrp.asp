...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-1.10.6-ps27yulh5dqbhkvvdipckcqg5b27dscr/bin/h5mkgrp
%----------------------------------------------------------------------------
...
abi_typelocation("a","MPI_Barrier","Import","Float64","%xmm0").
abi_typelocation("a","MPI_Barrier","Export","Integer64","%rax").
