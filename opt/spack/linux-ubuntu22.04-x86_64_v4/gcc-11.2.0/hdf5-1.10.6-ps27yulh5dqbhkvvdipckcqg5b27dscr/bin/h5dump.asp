...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-1.10.6-ps27yulh5dqbhkvvdipckcqg5b27dscr/bin/h5dump
%----------------------------------------------------------------------------
abi_typelocation("a","ompi_mpi_comm_world","Import","Integer8","var").
abi_typelocation("a","ompi_mpi_datatype_null","Import","Integer32","var").
abi_typelocation("a","MPI_Comm_create_keyval","Import","Integer8","(+8)").
abi_typelocation("a","MPI_Comm_create_keyval","Import","Integer8","+16").
abi_typelocation("a","MPI_Comm_create_keyval","Import","Integer8","+17").
