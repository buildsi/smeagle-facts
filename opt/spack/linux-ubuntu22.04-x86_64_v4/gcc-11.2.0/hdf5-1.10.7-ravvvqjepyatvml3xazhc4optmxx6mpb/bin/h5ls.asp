...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-1.10.7-ravvvqjepyatvml3xazhc4optmxx6mpb/bin/h5ls
%----------------------------------------------------------------------------
...
abi_typelocation("a","MPI_Info_get","Export","Integer64","%rdi").
abi_typelocation("a","MPI_Info_get","Export","Integer64","%rsi").
