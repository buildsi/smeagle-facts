...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-1.10.7-ravvvqjepyatvml3xazhc4optmxx6mpb/bin/h5format_convert
%----------------------------------------------------------------------------
abi_typelocation("a","ompi_mpi_comm_self","Import","Float32","var").
abi_typelocation("a","ompi_mpi_comm_null","Import","Integer64","var").
abi_typelocation("a","ompi_mpi_comm_null","Import","Integer64","var+8").
abi_typelocation("a","ompi_mpi_int","Import","Integer16","var").
abi_typelocation("a","ompi_mpi_unsigned_long_long","Import","Integer16","var").
abi_typelocation("a","ompi_mpi_c_bool","Import","Integer16","var").
