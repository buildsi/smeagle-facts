...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-1.10.7-ravvvqjepyatvml3xazhc4optmxx6mpb/bin/h5diff
%----------------------------------------------------------------------------
...
abi_typelocation("a","MPI_Type_create_resized","Import","Integer32","%rsi").
