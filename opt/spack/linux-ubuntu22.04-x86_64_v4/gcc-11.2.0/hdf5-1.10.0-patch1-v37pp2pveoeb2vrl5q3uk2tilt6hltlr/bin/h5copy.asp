...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-1.10.0-patch1-v37pp2pveoeb2vrl5q3uk2tilt6hltlr/bin/h5copy
%----------------------------------------------------------------------------
...
abi_typelocation("a","MPI_Type_create_resized","Both","Integer8","(%rsi)").
...
abi_typelocation("a","inflateEnd","Export","Integer32","%rdi").
abi_typelocation("a","inflateEnd","Export","Integer32","%rdi").
abi_typelocation("a","inflate","Export","Integer32","%rdi").
abi_typelocation("a","inflate","Export","Integer32","%rdi").
abi_typelocation("a","inflateInit_","Export","Integer32","%rdi").
abi_typelocation("a","inflateInit_","Export","Integer32","%rdi").
