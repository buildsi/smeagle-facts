...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-1.10.0-patch1-v37pp2pveoeb2vrl5q3uk2tilt6hltlr/bin/h5mkgrp
%----------------------------------------------------------------------------
...
abi_typelocation("a","MPI_File_read_at","Import","Integer64","%rdx").
...
abi_typelocation("a","MPI_File_read_at_all","Import","Integer64","%rdx").
...
abi_typelocation("a","MPI_File_set_view","Import","Array","%rsi").
