...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-develop-1.13-46nvbppu74g535ic7ojueo3xofi4jmfm/bin/h5stat
%----------------------------------------------------------------------------
...
abi_typelocation("a","MPI_Comm_free","Import","Array[16:16]","unknown").
abi_typelocation("a","MPI_Comm_free","Import","Integer8","unknown").
abi_typelocation("a","MPI_Comm_dup","Import","Array[16:16]","unknown").
abi_typelocation("a","MPI_Comm_dup","Import","Integer8","unknown").
abi_typelocation("a","MPI_Get_address","Import","Integer16","()").
abi_typelocation("a","MPI_Get_address","Import","Integer16","()+2").
abi_typelocation("a","MPI_Get_address","Import","Integer32","()+4").
abi_typelocation("a","MPI_Get_address","Import","Array[8:8]","()+8").
abi_typelocation("a","MPI_Get_address","Import","Integer8","()+8").
abi_typelocation("a","MPI_Error_string","Import","Integer32","%rdi").
abi_typelocation("a","MPI_Error_string","Export","Integer32","%rax").
abi_typelocation("a","MPI_Barrier","Export","Integer32","%rax").
