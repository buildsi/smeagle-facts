...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-1.13.1-wgamqwenbzojqpxuoj7mvjgt2lkauutk/bin/h5delete
%----------------------------------------------------------------------------
...
abi_typelocation("a","MPI_File_delete","Import","Array","%rdi").
abi_typelocation("a","MPI_File_delete","Import","Integer8","%rdi").
