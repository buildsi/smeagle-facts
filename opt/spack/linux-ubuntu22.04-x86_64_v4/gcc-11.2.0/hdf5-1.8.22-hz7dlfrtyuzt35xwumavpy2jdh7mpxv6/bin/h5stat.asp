...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-1.8.22-hz7dlfrtyuzt35xwumavpy2jdh7mpxv6/bin/h5stat
%----------------------------------------------------------------------------
...
abi_typelocation("a","MPI_Barrier","Import","Float32","%xmm0").
...
abi_typelocation("a","MPI_Allreduce","Import","Integer64","%rdx").
