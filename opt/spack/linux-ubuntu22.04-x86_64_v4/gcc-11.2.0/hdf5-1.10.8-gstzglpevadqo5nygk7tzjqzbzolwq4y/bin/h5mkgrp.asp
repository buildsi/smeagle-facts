...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-1.10.8-gstzglpevadqo5nygk7tzjqzbzolwq4y/bin/h5mkgrp
%----------------------------------------------------------------------------
...
abi_typelocation("a","MPI_Gatherv","Import","Integer16","%rsi").
abi_typelocation("a","MPI_Gatherv","Import","Integer16","%rdx").
abi_typelocation("a","MPI_Gatherv","Import","Integer8","()").
abi_typelocation("a","MPI_Allgatherv","Import","Integer64","%rdi").
abi_typelocation("a","MPI_Allgatherv","Import","Integer16","%rsi").
abi_typelocation("a","MPI_Allgatherv","Import","Integer16","%rdx").
