...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-1.10.8-gstzglpevadqo5nygk7tzjqzbzolwq4y/bin/h5repart
%----------------------------------------------------------------------------
abi_typelocation("a","MPI_Type_commit","Import","Integer64","%rdi").
abi_typelocation("a","MPI_Type_create_struct","Import","Integer64","%rsi").
...
abi_typelocation("a","MPI_Info_free","Import","Empty","(%rdi)").
abi_typelocation("a","MPI_Info_dup","Import","Empty","(%rdi)").
