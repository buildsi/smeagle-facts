...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-x86_64_v4/gcc-11.2.0/hdf5-1.8.16-4jn5ylaw4fv6ceubgruf6mpa2knibv2l/bin/h5debug
%----------------------------------------------------------------------------
abi_typelocation("a","MPI_Type_create_struct","Import","Function","%rdi").
abi_typelocation("a","MPI_File_write_at","Import","Void","()").
abi_typelocation("a","MPI_File_write_at_all","Import","Void","()").
