...
%----------------------------------------------------------------------------
% Library: /spack/opt/spack/linux-ubuntu22.04-broadwell/gcc-11.2.0/hdf5-develop-1.10-tjwkmmotpw5klozeyj7gwuhzcjkz5omw/bin/h5ls
%----------------------------------------------------------------------------
...
abi_typelocation("a","MPI_Get_address","Import","Array[20:20]","None").
abi_typelocation("a","MPI_Get_address","Export","Integer64","%rax").
abi_typelocation("a","MPI_Gather","Import","Integer64","%rdi").
abi_typelocation("a","MPI_Ibarrier","Import","Integer64","%rdi").
abi_typelocation("a","MPI_Irecv","Import","Integer64","%rdi").
abi_typelocation("a","MPI_Iprobe","Import","Integer64","%rdi").
abi_typelocation("a","MPI_Issend","Import","Integer64","%rdi").
abi_typelocation("a","MPI_Type_create_resized","Import","Integer8","%rdi").
abi_typelocation("a","MPI_Type_create_resized","Import","Integer8","%rsi").
...
abi_typelocation("a","MPI_Type_size_x","Import","Integer64","%rdi").
abi_typelocation("a","MPI_Type_size_x","Export","Integer32","%rax").
abi_typelocation("a","MPI_Get_elements_x","Import","Integer64","%rdi").
...
abi_typelocation("a","MPI_File_set_view","Both","Integer8","((%rdx))").
...
abi_typelocation("a","MPI_Type_dup","Import","Integer16","%rdi").
abi_typelocation("a","MPI_Type_create_resized","Import","Integer16","%rdi").
...
abi_typelocation("a","MPI_Type_create_hindexed","Import","Integer16","%rdx").
abi_typelocation("a","MPI_Type_create_hvector","Import","Integer16","%rdi").
abi_typelocation("a","MPI_Type_get_extent","Import","Integer16","%rdi").
abi_typelocation("a","MPI_Type_vector","Import","Integer16","%rdi").
abi_typelocation("a","MPI_Type_create_struct","Import","Integer32","%rdi").
abi_typelocation("a","MPI_Type_create_struct","Import","Integer32","%rsi").
...
abi_typelocation("a","MPI_Info_free","Import","Integer32","%rdi").
abi_typelocation("a","MPI_Info_dup","Import","Integer8","%rdi").
abi_typelocation("a","MPI_Info_dup","Import","Integer32","%rsi").
